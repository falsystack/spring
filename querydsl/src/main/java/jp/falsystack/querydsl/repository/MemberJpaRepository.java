...
import jp.falsystack.querydsl.dto.QMemberTeamDto;
import jp.falsystack.querydsl.entity.Member;
import jp.falsystack.querydsl.entity.QMember;
import jp.falsystack.querydsl.entity.QTeam;
...
import static jp.falsystack.querydsl.entity.QMember.*;
import static jp.falsystack.querydsl.entity.QTeam.*;
...
public class MemberJpaRepository {
    ...
    private BooleanExpression ageBetween(Integer ageLoe, Integer ageGoe) {
        if (ObjectUtils.isEmpty(ageLoe(ageLoe)) || ObjectUtils.isEmpty(ageGoe(ageGoe))) {
            return null;
        }
